...
interest, in real-time. For example, given a spoken command *"Can I have a small double-shot espresso"*, Rhino infers
that the user wants to order a drink with these specifications:
