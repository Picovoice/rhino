    ...
    <span className = "lighting-demo">
      <div className="text-center mb-5">
        <button
          ...
          className={
            "btn btn-cta transition-3d-hover " +
        ...
        >
          ...
          {demoLoading && "Loading…"}
          <span className="cta-spacer">&nbsp;</span>
        </button>
      </div>
      ...
      <div className={`house-container ${wakePhrase ? "active" : ""}`}>
        ...
        >
          ...
          {/* LIVING ROOM DESK */}
          <rect x="20" y="150" width="90" height="50" fill={FURNITURE_BLUE} />

          {/* LIVING ROOM CHAIR 1*/}
          <path d=" M 45,145 L 30,120 L60,120 Z" fill={FURNITURE_DARK_GRAY} />
          <ellipse
            cx="45"
            cy="135"
            rx="15"
          ...
          {/* LIVING ROOM CHAIR 2*/}
          <path d=" M 85,145 L 70,120 L100,120 Z" fill={FURNITURE_DARK_GRAY} />
          <ellipse
            cx="85"
            cy="135"
            rx="15"
