...
import { RhinoOptions, RhinoKeyword } from './types';
...
export class Rhino {
  private readonly _pvRhinoDelete: pv_porcupine_delete_type;
  private readonly _pvRhinoProcess: pv_porcupine_process_type;
